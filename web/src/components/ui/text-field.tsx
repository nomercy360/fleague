...
const TextField = <T extends ValidComponent = 'div'>(
	...
	return <TextFieldPrimitive.Root class={cn('w-full flex flex-col gap-1', local.class)} {...others} />
}
...
const TextFieldInput = <T extends ValidComponent = 'input'>(
	...
	return (
		<TextFieldPrimitive.Input
			type={local.type}
			class={cn(
				'flex h-12 w-full rounded-xl border border-input bg-secondary px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 data-[invalid]:border-error-foreground data-[invalid]:text-error-foreground',
				local.class,
			)}
			{...others}
		/>
